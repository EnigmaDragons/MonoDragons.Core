...
{
    public class VerticalFlyInAnimation : IAnimation
    {
        ...
        public VerticalDirection FromDir { get; set; } = VerticalDirection.Up;
        public VerticalDirection ToDir { get; set; } = VerticalDirection.Down;
        ...
        public VerticalFlyInAnimation(IVisual visual)
        {
            _visual = visual;
        }
        ...
        public void Start(Action onFinished)
        {
            ...
            _animations.Enqueue(Create(new WithOffset(_visual, new Vector2(0, x1)), x2, DurationWait));
            _animations.Enqueue(Create(new WithOffset(_visual, new Vector2(0, x1 + x2)), x3, DurationOut));
        ...
        {
            return new SinglePositionTraverseAnimation(visual, new Vector2(0, xMove), duration, TimeSpan.Zero);
        }
